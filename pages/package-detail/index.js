          ...
          <div className='grid lg:grid-cols-3 md:grid-cols-1 gap-3'>
            ...
            <div className='col-span-2 px-2'>
              ...
              <div className='justify-self-center	'>
                <img src='/icons/package/scanner-img.png'/>
              ...
              <div className='my-3'>
                ...
                <div className='grid lg:grid-cols-5 sm:grid-cols-1'>
                  ...
                  <div className='col-span-4 p-3' style={{borderBottom: '1px solid #f2f2f2'}}>13 Nights /12 Days</div>
                </div>
                <div className='grid lg:grid-cols-5 sm:grid-cols-1'>
            ...
            <div>
              ...
              <h1><b className='text-3xl'>₹54,566</b> per person*</h1>
